            ...
            try {
                ...
                const enriched = {
                    ...
                    chiTietSanPham: (chiTiet || []).map((ct: any) => ({
                        sanPham: ct.spId, // Backend trả về đối tượng sản phẩm trong field spId
                        soLuong: ct.soLuong,
                    })),
                };
                setOrder(enriched);
                // Lấy danh sách sản phẩm để đảm bảo có tên sản phẩm
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        const payload = {
                            ...
                            returnType,
                            items: chosenItems,
                            reason: reason === "Lý do khác" ? otherReason : reason,
                            refundMethod,
                            bank: refundMethod === "bank" ? { owner: bankOwner, number: bankNumber, bankName } : undefined,
                            imagesCount: selectedFiles.length,
                        };
                        console.log("Return request payload:", payload);
                        toast.success("Đã tạo yêu cầu hoàn hàng (demo)");
                    }}
                >
