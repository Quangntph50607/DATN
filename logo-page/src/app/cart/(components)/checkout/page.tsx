...
export default function CheckoutPage() {
    ...
    if (
      ...
      if (foundProvince) {
        ...
        const wardsForProvince = Object.entries(allWards as Record<string, any>)
          .filter(
            ([_, info]) => (info as any).parent_code === foundProvince.code
          )
  ...
  useEffect(() => {
    if (newAddressData.selectedProvince) {
      ...
      const wardsArr = Object.entries(allWards as Record<string, any>)
        .filter(
          ([_, info]) =>
            (info as any).parent_code === newAddressData.selectedProvince
        )
        .map(([code, info]) => ({ code, ...(info as any) }));
      setWards(wardsArr);
    } else {
  ...
  const handleApplyVoucher = () => {
    ...
    if (v) {
      ...
      else if (v.loaiPhieuGiam === "Theo số tiền")
        setDiscount(v.giaTriGiam || 0);
    } else {
      setDiscount(0);
  ...
  useEffect(() => {
    ...
    const calculateShippingFee = () => {
      ...
      const khuVuc = isNoiThanh(provinceName, wardName)
        ? "Nội thành"
        : "Ngoại thành";
  ...
  const handleOrder = async () => {
    ...
    try {
      ...
      if (paymentMethod === "COD") {
        ...
        phuongThucThanhToan = "COD";
        console.warn(
          "[DEBUG] paymentMethod không phải 'COD' hoặc 'Chuyển khoản', giá trị:",
          paymentMethod
        );
      }
      ...
      if (paymentMethod === "COD") {
        ...
        const successUrl = `/cart/checkout/success?hoaDonId=${
          hoaDon.id
        }&ngayLap=${encodeURIComponent(
          formatDateVN(ngayDatHang)
        )}&ngayGiao=${encodeURIComponent(formatDateVN(ngayGiaoHang))}`;
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/5 w-full order-2 md:order-none flex flex-col gap-4">
                          ...
                          <div>
                            ...
                            <ReusableCombobox
                              ...
                              onSelect={(id) =>
                                setNewAddressData({
                                  ...newAddressData,
                                  selectedProvince: (id as number) || null,
                                })
                              }
                              placeholder="Chọn tỉnh/thành phố"
                              showAllOption={false}
                          ...
                          <div>
                            ...
                            <ReusableCombobox
                              ...
                              onSelect={(id) =>
                                setNewAddressData({
                                  ...newAddressData,
                                  selectedWard: (id as number) || null,
                                })
                              }
                              placeholder="Chọn xã/phường"
                              showAllOption={false}
            ...
            <div>
              ...
              >
                <option value="Nhanh" className="text-black">
                  Nhanh
                </option>
                <option value="Chậm" className="text-black">
                  Chậm
                </option>
              </select>
                        ...
                        return (
                          ...
                          >
                            ...
                            <input
                              ...
                              onChange={() =>
                                handleSelectVoucherRadio(v.maPhieu || "")
                              }
            ...
            <div>
              ...
              >
                ...
                <option value="Chuyển khoản" className="text-black">
            ...
            <div className="bg-gray-50 rounded p-4 mt-2">
              ...
              <button
                className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-3 rounded text-lg w-full mt-4 disabled:bg-orange-300 disabled:cursor-not-allowed"
                onClick={handleOrder}
