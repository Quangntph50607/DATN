...
// const getMainImageUrl = (anhUrls: any[]) => {
//     if (!anhUrls || anhUrls.length === 0) return '/no-image.png';
//     const mainImg = anhUrls.find((img: any) => img.anhChinh);
...
//         // Cho phép đơn hàng khách lẻ không có số điện thoại, nhưng sử dụng giá trị mặc định cho hệ thống
//         const phoneForOrder = customerPhone || "KHACHLE";
