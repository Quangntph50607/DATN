...
const loaiHDOptions: { value: string; label: string }[] = [
  ...
  { value: "1", label: "Tại quầy" },
  { value: "2", label: "Online" },
>>>>>>> 0dc57a60f74ea3bab67fef48e7b09394ebb5c4bd
];
                    ...
                    <TableHeader>
                        <TableRow className="bg-[#232b3b]">
                            {[
                                ...
                                <TableHead key={idx} className="text-white text-center text-sm font-semibold bg-[#113c91]">
                                    {header}
                                </TableHead>
                            ))}
                        </TableRow>
...
=======
      data?.content.filter((hd) => String(hd.loaiHD) === filterLoaiHD) || []
>>>>>>> 0dc57a60f74ea3bab67fef48e7b09394ebb5c4bd
    );
  }, [data, filterLoaiHD]);
          ...
          <TableBody>
            {filteredData.map((hd: HoaDonDTO, index) => (
              ...
              >
                ...
                <TableCell>
                  {parseBackendDate(hd.ngayTao)?.toLocaleString("vi-VN") ||
                    "N/A"}
                </TableCell>
