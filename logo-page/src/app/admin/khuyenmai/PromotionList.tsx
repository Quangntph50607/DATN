...
const PromotionList: React.FC<PromotionListProps> = ({
    ...
    const getStatusVariant = (status: string | undefined): "default" | "secondary" | "destructive" | "outline" | "success" => {
        switch (status) {
            case 'Đang hoạt động':
                return "success";
            case 'Sắp diễn ra':
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>Giá trị tối đa</TableHead>
                        ...
                        {loading ? (
                            ...
                            promotions.map((promo) => (
                                <TableRow key={promo.id}>
                                    ...
                                    <TableCell>{promo.soLuong}</TableCell>
                                    <TableCell>{promo.giaTriGiam?.toLocaleString() || 0} VND</TableCell>
                                    <TableCell>{promo.giaTriToiDa?.toLocaleString() || 'N/A'} VND</TableCell>
                                    ...
                                    <TableCell>
                                        <Badge variant={getStatusVariant(promo.trangThai)}>{promo.trangThai || 'Không xác định'}</Badge>
                                    </TableCell>
