...
const PromotionForm: React.FC<PromotionFormProps> = ({
    ...
    const [selectedProducts, setSelectedProducts] = useState<string[]>(
        newPromotion.sanPhamApDung ? newPromotion.sanPhamApDung.split(',').map(p => p.trim()) : []
    );
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 promotion-form border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-6 border-b pb-4">
                ...
                {editingPromotion && (
                    <Badge variant={getStatusVariant(newPromotion.trangThai || getStatus())} className="text-sm px-3 py-1">
            ...
            <form onSubmit={onSubmit} className="space-y-8">
                ...
                <div className="space-y-2">
                    <Label htmlFor="maKhuyenMai" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    {/* Số lượng */}
                    <div className="space-y-2">
                        <Label htmlFor="soLuong" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                    ...
                    {/* Giá trị giảm */}
                    <div className="space-y-2">
                        <Label htmlFor="giaTriGiam" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                    ...
                    {/* Giá trị tối đa */}
                    <div className="space-y-2">
                        <Label htmlFor="giaTriToiDa" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                            Giá trị tối đa (VND)
                        </Label>
                        <Input
                            id="giaTriToiDa"
                    ...
                    {/* Phần trăm giảm */}
                    <div className="space-y-2">
                        <Label htmlFor="phanTramGiam" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="ngayBatDau" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    style={{ color: startDate ? '#000000 !important' : '#6b7280 !important' }}
                                >
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="ngayKetThuc" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    style={{ color: endDate ? '#000000 !important' : '#6b7280 !important' }}
                                >
                                    <CalendarIcon className="mr-2 h-4 w-4 text-gray-500" />
                ...
                {/* Trạng thái */}
                <div className="space-y-2">
                    <Label htmlFor="trangThai" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                        Trạng thái
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute right-3 top-2">
                            <Badge variant={getStatusVariant(newPromotion.trangThai || getStatus())}>
                                {newPromotion.trangThai || getStatus()}
                            </Badge>
                        </div>
                    </div>
                    <p className="text-xs text-gray-500 italic mt-1">Tự động cập nhật từ hệ thống</p>
                </div>
                {/* Sản phẩm áp dụng */}
                <div className="space-y-2">
                    <Label htmlFor="sanPhamApDung" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                        Sản phẩm áp dụng
                    </Label>
                    <div className="flex flex-col space-y-2">
                                ...
                                {isLoadingProducts ? (
                                    ...
                                    products.map(product => (
                                        <SelectItem
                                            ...
                                            disabled={selectedProducts.includes(product.maSanPham.toString())}
                                        >
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {selectedProducts.map(productId => {
                                const product = products?.find(p => p.maSanPham.toString() === productId);
                                return (
                                    <Badge
                                        key={productId}
                                        variant="secondary"
                ...
                {/* Mô tả */}
                <div className="space-y-2">
                    <Label htmlFor="moTa" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                        Mô tả
                    </Label>
                    <Textarea
                        id="moTa"
